    ...
    return (
      <div className="h-screen w-screen flex items-center justify-center px-6">
        <div className="max-w-2xl w-full rounded-3xl border border-white/10 bg-black/30 backdrop-blur-sm shadow-soft p-8">
          <div className="text-xs uppercase tracking-widest text-white/60">Sistema de reconstrucción académica</div>
          <h1 className="mt-3 text-2xl md:text-3xl font-semibold">
            ADN, “Genoma del Vacío” (metáfora) y Universo inspirado en Einstein
          </h1>
          <p className="mt-4 text-white/80 leading-relaxed">
            Se separa explícitamente <b>representación científica</b> (ADN) de <b>metáforas/modelos didácticos</b>{" "}
            (campo de fluctuaciones procedimental, curvatura inspirada en Einstein, auto-organización celular).
          </p>
